...
My goal is to investigate the Brunn-Minkowski inequality not just as a geometric theorem, but as a crossroads between analysis, geometry, and probability. To achieve this, I have structured my work into four distinct phases, moving from fundamental tools to advanced applications.
...
Measure Theory: Revisiting the construction of the Lebesgue measure and the critical role of Fubini's theorem in slicing arguments.
...
This site is built with Jekyll and hosted on GitHub Pages as a "Build in Public" academic initiative.
